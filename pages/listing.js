...
const Listing = (data) => {
  ...
  return (
    <div className="text-left bg-gray-50 text-gray-800 py-16 px-16">
      <div className="pb-16">
        <h1 className="text-7xl font-bold mt-0 mb-6 text-Orange">
          Carrots and Peas
        </h1>{" "}
        {/** will eventually be replaced with dynamic data*/}
        <div className="flex flex-row">
          <SVG name="star" className="text-Orange w-5" />
          <p className="text-xl pl-2">
            4.8 | 48 Reviews — 114 E 1750 S, Perry, UT 84302
          </p>
        </div>
      </div>
      ...
      <div className="flex pt-16">
          ...
          <div className="flex flex-row py-7 mx-7 border-b">
            ...
            <div>
              ...
              <p className="text-base">
                I’m a new gardener, and got a lot of veggies this season. Just
                wanting to get rid of my extra produce!
              </p>
            </div>
          </div>
        ...
        <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
          <h5 className="text-Orange text-4xl leading-tight font-medium mb-2">
            $5 per bunch
          </h5>
          ...
          <p className="text-gray-700 text-base mb-4">
            AVAILABILITY: We have mainly carrots and peas, but some other
            produce is available as well on request.
          </p>
          <button
            type="button"
            className="w-full px-6 py-2.5 bg-Sage text-white font-medium text-xs leading-tight 
